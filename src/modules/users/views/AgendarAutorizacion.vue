            ...
            <div class="card">
                ...
                <form class="card-body" @submit.prevent="agendarAutorizacionEvent">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div v-if="UnSoloDia">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="inputRangoFechaInicialAgendarAutorizacion"
                            ...
                            <div v-else>
                                <div class="mb-3">
                                    <label for="inputFechaAgendarAutorizacion"><strong>Fecha de ingreso:</strong></label>
                            ...
                            <div class="mb-3">
                                <label for="inputHoraEntradaAgendarAutorizacion"><strong>Hora de entrada:</strong></label>
                        ...
                        <div class="col-md-7">
                            <div class="mb-3">
                                <label for="inputDocumentoArlAgendarAutorizacion"><strong>Documento de ARL</strong></label>
                                <input type="file" class="form-control" id="inputDocumentoArlAgendarAutorizacion"
                                    aria-describedby="inputDocumentoArlAgendarAutorizacion" required @change="changeFileArl"
                                    accept="application/pdf" />
                            </div>
                            <div class="mb-3">
                                <label for="inputDocumentoIdentificacionAgendarAutorizacion"><strong>Documento de
                                        Identificación</strong></label>
                                <input type="file" class="form-control" id="inputDocumentoIdentificacionAgendarAutorizacion"
                                    aria-describedby="inputIdentificacionAgendarAutorizacion" required
                                    @change="changeFileIdentificacion" accept="application/pdf" />
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="inputDocumentoEpsAgendarAutorizacion"
                                    aria-describedby="inputDocumentoEpsAgendarAutorizacion" required @change="changeFileEps"
                                    accept="application/pdf" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="inputMunicipioAgendarAutorizacion"><strong>Digite el municipio</strong></label>
