            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form @submit.prevent="registrarIncidenteEvent">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control" placeholder="Descripcion" name="descripcionRegistrarIncidencia"
                                id="descripcionRegistrarIncidencia" cols="60" rows="8"
                                v-model="registrarIncidenteForm.Descripcion">
                            </textarea>
                        </div>
